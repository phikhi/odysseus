...
> ⚠️ **En construction.** 26 tickets sur 38 sont livrés. La boucle tourne de bout en bout, le gate décide vraiment — palier objectif *et* palier de jugement — et un échec ne laisse plus le dépôt sale, mais il manque encore le budget d'usage, la boucle humaine et le reçu d'audit — voir [État](#état). Ne le lâchez pas encore sur un dépôt qui compte.
