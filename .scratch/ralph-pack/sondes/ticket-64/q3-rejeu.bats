...
#
#   playthrough.sh:494  playthrough__strangers      [11]
...
@test "Q3d playthrough__strangers au module : la voix passe-t-elle ?" {
  use_tickets 01-alpha
  sonde__plant

  pack_run 'playthrough__strangers'
  printf '=== playthrough__strangers rc=%s\n' "$status"
...
FAKE
  ...
  pack_run 'playthrough__strangers'
  printf '=== playthrough__strangers    : %s\n' "$output"
  printf '=== sortie du run -----------------------------------\n%s\n' "$runout"
